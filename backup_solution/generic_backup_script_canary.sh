...
SOURCES="/storage/900B-8135 /storage/emulated/0/ "
TARGET="/home/jens/canary/backup"
...
RSYNCCONF=(--backup --backup-dir=backup --suffix=$RANDOM --exclude=Downloads --exclude=DCIM --exclude=Pictures)
